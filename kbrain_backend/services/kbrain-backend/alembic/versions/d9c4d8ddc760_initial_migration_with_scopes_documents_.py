...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "processing_started", postgresql.TIMESTAMP(timezone=True), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_documents_scope_id"), "documents", ["scope_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_processing_queue_document_id"),
        "processing_queue",
        ["document_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_processing_queue_priority"),
        "processing_queue",
        ["priority"],
        unique=False,
    )
    op.create_index(
        op.f("ix_processing_queue_scheduled_at"),
        "processing_queue",
        ["scheduled_at"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_processing_queue_scheduled_at"), table_name="processing_queue"
    )
    op.drop_index(op.f("ix_processing_queue_priority"), table_name="processing_queue")
    op.drop_index(
        op.f("ix_processing_queue_document_id"), table_name="processing_queue"
    )
